...
{
    [TestFixture]
    public class MiniAdo_DotNetTransactionTest
    {
        [OneTimeSetUp]
        ...
        [Test]
        public void Test_DotNetTransaction_Commit_SimpleQuery()
        {
        ...
        [Test]
        public void Test_DotNetTransaction_Rollback_SimpleQuery()
        {
            using (var ctx = Helper.CreateMsSql())
            {
                using (var ts = ctx.StartTransaction(System.Data.IsolationLevel.ReadUncommitted))
        ...
        [Test]
        public void Test_DotNetTransaction_Commit_MultiInsert()
        {
            ...
            using (var ctx = Helper.CreateMsSql())
            {
                using (var ts = ctx.StartTransaction())
                {
                    try
                    {
        ...
        [Test]
        public void Test_DotNetTransaction_Rollback_MultiInsert()
        {
            var insertedData = new object[]
            {
        ...
        [Test]
        public void Test_DotNetTransaction_Commit_MultiInsert_WithMerge()
        {
            var insertedData = new object[]
            {
        ...
        [Test]
        public void Test_DotNetTransaction_Rollback_MultiInsert_WithMerge()
        {
            var insertedData = new object[]
            {
